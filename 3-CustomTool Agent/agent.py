...
root_agent = LlmAgent(
    ...
    You have two tools:
    1. A 'google_search' tool for general questions and current events.
    2. A 'get_current_time' tool for questions about the date or time. 
    
    You MUST use the 'google_search' tool for any question
    you do not know the answer to.
    
    You MUST use the 'get_current_time' tool for any question
